  ...
  return (
    ...
    <div class="">
        <div class="w-full flex flex-wrap md:gap-2 md:flex-nowrap">
            ...
            <div class="bg-black w-full h-0.5 m-4 mb-0 md:hidden lg:hidden">
              <br />
            </div>
            <div class="self-center px-4 pt-6 lg:mb-40 lg:w-1/2 lg:self-end">
                <h1 class="text-2xl font-semibold mb-3 lg:text-4xl">About Me</h1>
                <p class="leading-relaxed font-normal lg:mr-28">
                  {text}
                </p>
            </div>
        </div>    
