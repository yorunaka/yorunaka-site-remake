...
const Contacts = () => {
  return (
    <section id="contact" class="pb-16 lg:p-16">
        <div class="">
            <div class="flex flex-wrap">
                <div class="w-full self-center px-4 mb-8 text-center">
                    <h1 class="text-2xl font-semibold lg:text-4xl">Know More About Me!</h1>
        ...
        <div class=" ">
            <div class="flex flex-wrap justify-center">
                <div class="w-auto self-center px-4">
                        <div class="bg-white rounded-lg shadow-lg py-4 px-6 lg:">
